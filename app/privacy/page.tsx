...
async function getPrivacy() {
  const { data } = await supabase
    ...
    .single()
  return data?.content || { title: "Privacy Policy", body: "Please set privacy policy in Admin Dashboard." }
}
  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        <h1 className="text-5xl md:text-7xl font-serif text-foreground mb-12">{privacy.title}</h1>
        <div 
